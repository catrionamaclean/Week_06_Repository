...
fev_data[32, ] # Everything in the 32rd row

fev_data[32,1:3] #32rd row, only columns 1 to 3

fev_data[32,-5] #32rd row, all but column 5

fev_data[32,-1:-2] #32rd row, not columns 1 to 2

fev_data[32,c(1,3,5)] #c(1,3,5) is a vector of numbers (c means "combine")

c(1,3,5) %>%
  length # how long is the resulting vector (how many items in it)
```
